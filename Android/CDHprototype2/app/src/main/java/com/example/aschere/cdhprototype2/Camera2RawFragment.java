 ...
 * </ul>
 */
public class Camera2RawFragment
{
	...
	//Activity parameters, obtained from MainActivity
	private CameraManager manager;
	private Context appContext;
	private static String imageToReturn;
	private static boolean imageReturnable = false;
			...
			= new CameraCaptureSession.CaptureCallback()
	{
		                             ...
		                             long timestamp, long frameNumber)
		{
			...
			imageToReturn = "RAW_" + currentDateTime + ".dng";
			imageReturnable = true;
			...
			File jpegFile = new File(Environment.
					getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM),
					imageToReturn);
			Log.i("Supposed Filename", imageToReturn);
	...
	private Camera2RawFragment(CameraManager cameraManager, Context applicationContext)
	{
	...
	public static Camera2RawFragment newInstance(CameraManager cameraManager, Context appContext)
	{
		return new Camera2RawFragment(cameraManager, appContext);
	}
            ...
            switch (format) {
                ...
                case ImageFormat.RAW_SENSOR: {
                    ...
                    try {
	                    ...
	                    imageToReturn = mFile.getName();
	                    imageReturnable = true;
	                    Log.i(TAG, imageToReturn);
                        mImage.close();
                        closeOutput(output);
                    }
                    break;
